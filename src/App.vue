...
import HeroInterludeImage from '@/sections/HeroInterludeImage.vue'
...
import VibeGallerySection from '@/sections/VibeGallerySection.vue'
...
<template>
  <div class="min-h-dvh bg-sand-50 font-sans">
    <a
      href="#top"
